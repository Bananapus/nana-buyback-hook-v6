...
contract JBBuybackHook is JBPermissioned, ERC2771Context, IUnlockCallback, IJBBuybackHook {
    ...
    /// @return taxTotalSupply The total supply to use for tax calculation purposes.
        ...
        )
    {
        ...
        // taxTotalSupply defaults to totalSupply (0 signals "use totalSupply" to the caller).
