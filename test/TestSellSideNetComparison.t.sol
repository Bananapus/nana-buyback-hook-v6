...
contract TestSellSideNetComparison is Test {
    ...
    // Scenario: cashOutCount=10, totalSupply=100, surplus=5, taxRate=0
    // gross = 10/100 * 5 = 0.5 ether
    // fee = 0.5 * 25/1000 = 0.0125 ether
    // net = 0.5 - 0.0125 = 0.4875 ether
    uint256 constant GROSS = 0.5 ether;
    uint256 constant NET = 0.4875 ether;
    ...
    function test_ammQuoteBetweenNetAndGross_routesToAmm() public view {
        // 0.49 ether is between net (0.4875) and gross (0.5)
    ...
    function test_ammQuoteBelowNet_routesToTerminal() public view {
        // 0.48 ether is below net (0.4875)
    ...
    function test_feelessBeneficiary_comparesAgainstGross() public view {
        // 0.49 ether is between net (0.4875) and gross (0.5).
        // With feeless, comparison is against gross 0.5 → noop because 0.49 <= 0.5.
        uint256 ammQuote = 0.49 ether;
